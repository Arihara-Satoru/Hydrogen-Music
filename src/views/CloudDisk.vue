<script setup>
  ...
  // ponytail: these stay hidden until the KuGou backend exposes matching capabilities.
  const supportsNonMusicFiles = false
  const supportsCloudUpload = false

  const CLOUD_CATEGORY_LABELS = {
    [CLOUD_CATEGORY_ALL]: '全部音乐',
        ...
        <div class="disk-info" v-if="cloudSongs">
          ...
          <div class="info-title">云盘信息</div>
            <div class="info-list">
              ...
              <div class="info-item" v-if="safeCapacityMax > 0">
